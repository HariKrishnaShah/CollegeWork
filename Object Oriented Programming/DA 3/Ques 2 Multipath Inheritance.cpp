...
class Book_Sale_without_CD: virtual public Book_Details{
	protected:
		int sales_quantity;
		float price;
	public:
...
class Book_Sale_with_CD: virtual public Book_Details{
	protected:
		int sale_quantity;
		float prices;
	public:
...
class Book_Overall:public Book_Sale_without_CD, public Book_Sale_with_CD{
	protected:

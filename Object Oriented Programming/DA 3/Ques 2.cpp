...
class Book_Sale_without_CD: public Book_Details{
	...
	public:
		...
		void display_class(){
			cout<<"The details for sales of book without CD is given below."<<endl;
			Book_Details::display();
			cout<<"The sales quantity is "<<sales_quantity<<"."<<endl;
...
class Book_Overall: public Book_Sale_without_CD, virtual public Book_Sale_with_CD{
	protected:
	...
	public:
		...
		void calculate(){
			int total_sale_quantity = Book_Sale_without_CD::sales_quantity + Book_Sale_with_CD::sale_quantity;
			float total_sale_amount = (Book_Sale_without_CD::sales_quantity*Book_Sale_without_CD::price) + (Book_Sale_with_CD::sale_quantity*Book_Sale_with_CD::prices);
		}
		void display(){

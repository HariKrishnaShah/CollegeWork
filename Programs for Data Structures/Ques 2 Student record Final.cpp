...
int main(){
	...
	while(option != -1){
		printf("\t\t\tThis program is made by Hari Krisna Shah !!!\n");
		printf("Welcome to the Main Menu.\n");
		printf("Please choose an option from the menu below\n \
		Enter 1 to create and add student records\n \
		...
		Enter 6 to delete the student record of a student\n \
		Enter 7 to delete the node before a roll number\n \
		Enter 8 to delete the node after a roll number \n \
		Enter 9 to delete the entire student record except a specified student\n \
		Enter 10 to delete the entire student record\n \
		Enter 11 to count the number of nodes\n \
		Enter 12 to add in the first node\n \
		Enter 13 to add before searched roll number\n \
		Enter 14 to add after searched roll number\n \
		Enter 15 to add or edit data in the searched node\n \
...
struct node *ptr, *match, *succedptr, *preptr;
	...
	printf("\n\nHere is the record of searched student.\n");
	display(match);
